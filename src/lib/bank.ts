...
function initialState(): BankState {
  return {
    ...
    beneficiaries: [
      {
        id: "pix-demo-1",
        name: "MARIA AUXILIADORA DE OLIVEIRA",
        doc: "000.000.000-00",
        bank: "341 — Banco Horizonte (fictício)",
        branch: "0001",
        account: "00000000-0",
      },
      {
        id: "pix-demo-2",
        name: "MARIA JOSE DE OLIVEIRA",
        doc: "000.000.000-00",
        bank: "104 — Caixa Brasil (fictício)",
        branch: "0002",
        account: "00000001-0",
      },
      {
        id: "pix-demo-3",
        name: "TATIANE DE OLIVEIRA",
        doc: "000.000.000-00",
        bank: "237 — Bradesco Demo (fictício)",
        branch: "0003",
        account: "00000002-0",
      },
      {
        ...
        doc: "000.000.000-00",
        bank: "001 — Banco Central Demo (fictício)",
        branch: "0004",
        account: "00000003-0",
      },
      {
        id: "pix-demo-5",
        name: "VIVIANI DE OLIVEIRA SOUZA",
        doc: "000.000.000-00",
        bank: "748 — Banco União Demo (fictício)",
        branch: "0005",
        account: "00000004-0",
      },
      {
        id: "pix-demo-6",
        name: "CLEIDIANE DOS PASSOS OLIVEIRA",
        doc: "000.000.000-00",
        bank: "260 — Banco Digital Demo (fictício)",
        branch: "0006",
        account: "00000005-0",
      },
      {
        id: "pix-demo-7",
        name: "KATIANE DE OLIVEIRA",
        doc: "000.000.000-00",
        bank: "033 — Banco Sul Demo (fictício)",
        branch: "0007",
        account: "00000006-0",
      },
      {
        id: "pix-demo-8",
        name: "JOSÉ MARIA GOMES PEIXOTO",
        doc: "000.000.000-00",
        bank: "336 — Banco Atlântico Demo (fictício)",
        branch: "0008",
        account: "00000007-0",
      },
      {
        id: "pix-demo-9",
        name: "ELIANE PEGO DE OLIVEIRA",
        doc: "000.000.000-00",
        bank: "208 — Banco Norte Demo (fictício)",
        branch: "0009",
        account: "00000008-0",
      },
      {
        id: "pix-demo-10",
        name: "ADRIANO DE SOUZA PARANHOS",
        doc: "000.000.000-00",
        bank: "748 — Banco União Demo (fictício)",
        branch: "0010",
        account: "00000009-0",
