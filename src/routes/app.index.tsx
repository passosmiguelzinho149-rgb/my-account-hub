      ...
      <main className="bg-background px-5 pb-8 pt-5">
        ...
        <section className="mt-7">
          ...
          <div className="mt-3 flex gap-3 overflow-x-auto pb-2">
            ...
            <Link to="/app/servicos" className="flex min-w-[116px] flex-col items-center justify-center rounded-2xl bg-card px-3 py-4 text-center shadow-[0_8px_25px_rgba(30,50,70,0.08)]">
            ...
            <Link to="/app/credito" className="flex min-h-[150px] items-stretch">
              <div className="w-[30%] bg-gradient-to-br from-red-100 via-red-50 to-white p-4">
                <div className="flex h-full items-end justify-center">
                  <img src="https://images.unsplash.com/photo-1753161022783-160d6579f86d?auto=format&fit=crop&fm=jpg&ixlib=rb-4.1.0&q=80&w=700" alt="Mulher usando celular" className="h-full w-full object-cover" />
                </div>
              </div>
